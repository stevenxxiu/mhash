...
static word32 gost_sbox_3[256] = {
	...
	0x30000002UL, 0x60000002UL, 0x38000002UL, 0x8000002UL,
	    0x28000002UL,
	0x78000002UL, 0x68000002UL, 0x40000002UL, 0x20000002UL,
	    0x50000002UL,
	0x48000002UL, 0x70000002UL, 0x2UL, 0x18000002UL, 0x58000002UL,
	0x10000002UL, 0xB0000005UL, 0xE0000005UL, 0xB8000005UL,
	    0x88000005UL,
	0xA8000005UL, 0xF8000005UL, 0xE8000005UL, 0xC0000005UL,
	    0xA0000005UL,
	0xD0000005UL, 0xC8000005UL, 0xF0000005UL, 0x80000005UL,
	    0x98000005UL,
	0xD8000005UL, 0x90000005UL, 0x30000005UL, 0x60000005UL,
	    0x38000005UL,
	0x8000005UL, 0x28000005UL, 0x78000005UL, 0x68000005UL,
	    0x40000005UL,
	0x20000005UL, 0x50000005UL, 0x48000005UL, 0x70000005UL, 0x5UL,
	0x18000005UL, 0x58000005UL, 0x10000005UL, 0x30000000UL,
	    0x60000000UL,
	0x38000000UL, 0x8000000UL, 0x28000000UL, 0x78000000UL,
	    0x68000000UL,
	0x40000000UL, 0x20000000UL, 0x50000000UL, 0x48000000UL,
	    0x70000000UL,
	0x0UL, 0x18000000UL, 0x58000000UL, 0x10000000UL, 0xB0000003UL,
	0xE0000003UL, 0xB8000003UL, 0x88000003UL, 0xA8000003UL,
	    0xF8000003UL,
	0xE8000003UL, 0xC0000003UL, 0xA0000003UL, 0xD0000003UL,
	    0xC8000003UL,
	0xF0000003UL, 0x80000003UL, 0x98000003UL, 0xD8000003UL,
	    0x90000003UL,
	0x30000001UL, 0x60000001UL, 0x38000001UL, 0x8000001UL,
	    0x28000001UL,
	0x78000001UL, 0x68000001UL, 0x40000001UL, 0x20000001UL,
	    0x50000001UL,
	0x48000001UL, 0x70000001UL, 0x1UL, 0x18000001UL, 0x58000001UL,
	0x10000001UL, 0xB0000000UL, 0xE0000000UL, 0xB8000000UL,
	    0x88000000UL,
	0xA8000000UL, 0xF8000000UL, 0xE8000000UL, 0xC0000000UL,
	    0xA0000000UL,
	0xD0000000UL, 0xC8000000UL, 0xF0000000UL, 0x80000000UL,
	    0x98000000UL,
	0xD8000000UL, 0x90000000UL, 0xB0000006UL, 0xE0000006UL,
	    0xB8000006UL,
	0x88000006UL, 0xA8000006UL, 0xF8000006UL, 0xE8000006UL,
	    0xC0000006UL,
	0xA0000006UL, 0xD0000006UL, 0xC8000006UL, 0xF0000006UL,
	    0x80000006UL,
	0x98000006UL, 0xD8000006UL, 0x90000006UL, 0xB0000001UL,
	    0xE0000001UL,
	0xB8000001UL, 0x88000001UL, 0xA8000001UL, 0xF8000001UL,
	    0xE8000001UL,
	0xC0000001UL, 0xA0000001UL, 0xD0000001UL, 0xC8000001UL,
	    0xF0000001UL,
	0x80000001UL, 0x98000001UL, 0xD8000001UL, 0x90000001UL,
	    0x30000003UL,
	0x60000003UL, 0x38000003UL, 0x8000003UL, 0x28000003UL,
	    0x78000003UL,
	0x68000003UL, 0x40000003UL, 0x20000003UL, 0x50000003UL,
	    0x48000003UL,
	0x70000003UL, 0x3UL, 0x18000003UL, 0x58000003UL, 0x10000003UL,
	0x30000004UL, 0x60000004UL, 0x38000004UL, 0x8000004UL,
	    0x28000004UL,
	0x78000004UL, 0x68000004UL, 0x40000004UL, 0x20000004UL,
	    0x50000004UL,
	0x48000004UL, 0x70000004UL, 0x4UL, 0x18000004UL, 0x58000004UL,
	0x10000004UL, 0xB0000002UL, 0xE0000002UL, 0xB8000002UL,
	    0x88000002UL,
	0xA8000002UL, 0xF8000002UL, 0xE8000002UL, 0xC0000002UL,
	    0xA0000002UL,
	0xD0000002UL, 0xC8000002UL, 0xF0000002UL, 0x80000002UL,
	    0x98000002UL,
	0xD8000002UL, 0x90000002UL, 0xB0000004UL, 0xE0000004UL,
	    0xB8000004UL,
	0x88000004UL, 0xA8000004UL, 0xF8000004UL, 0xE8000004UL,
	    0xC0000004UL,
	0xA0000004UL, 0xD0000004UL, 0xC8000004UL, 0xF0000004UL,
	    0x80000004UL,
	0x98000004UL, 0xD8000004UL, 0x90000004UL, 0x30000006UL,
	    0x60000006UL,
	0x38000006UL, 0x8000006UL, 0x28000006UL, 0x78000006UL,
	    0x68000006UL,
	0x40000006UL, 0x20000006UL, 0x50000006UL, 0x48000006UL,
	    0x70000006UL,
	0x6UL, 0x18000006UL, 0x58000006UL, 0x10000006UL, 0xB0000007UL,
	0xE0000007UL, 0xB8000007UL, 0x88000007UL, 0xA8000007UL,
	    0xF8000007UL,
	0xE8000007UL, 0xC0000007UL, 0xA0000007UL, 0xD0000007UL,
	    0xC8000007UL,
	0xF0000007UL, 0x80000007UL, 0x98000007UL, 0xD8000007UL,
	    0x90000007UL,
	0x30000007UL, 0x60000007UL, 0x38000007UL, 0x8000007UL,
	    0x28000007UL,
	0x78000007UL, 0x68000007UL, 0x40000007UL, 0x20000007UL,
	    0x50000007UL,
...
static void gosthash_compress(word32 * h, word32 * m)
{
	...
	for (i = 0; i < 8; i += 2) {
		...
		key[0] = (w[0] & 0x000000ff) | ((w[2] & 0x000000ff) << 8) |
		    ((w[4] & 0x000000ff) << 16) | ((w[6] & 0x000000ff) <<
						   24);
		key[1] =
		    ((w[0] & 0x0000ff00) >> 8) | (w[2] & 0x0000ff00) |
		    ((w[4] & 0x0000ff00) << 8) | ((w[6] & 0x0000ff00) <<
						  16);
		key[2] =
		    ((w[0] & 0x00ff0000) >> 16) | ((w[2] & 0x00ff0000) >>
						   8) | (w[4] & 0x00ff0000)
		    | ((w[6] & 0x00ff0000) << 8);
		key[3] =
		    ((w[0] & 0xff000000) >> 24) | ((w[2] & 0xff000000) >>
						   16) |
		    ((w[4] & 0xff000000) >> 8) | (w[6] & 0xff000000);
		key[4] =
		    (w[1] & 0x000000ff) | ((w[3] & 0x000000ff) << 8) |
		    ((w[5] & 0x000000ff) << 16) | ((w[7] & 0x000000ff) <<
						   24);
		key[5] =
		    ((w[1] & 0x0000ff00) >> 8) | (w[3] & 0x0000ff00) |
		    ((w[5] & 0x0000ff00) << 8) | ((w[7] & 0x0000ff00) <<
						  16);
		key[6] =
		    ((w[1] & 0x00ff0000) >> 16) | ((w[3] & 0x00ff0000) >>
						   8) | (w[5] & 0x00ff0000)
		    | ((w[7] & 0x00ff0000) << 8);
		key[7] =
		    ((w[1] & 0xff000000) >> 24) | ((w[3] & 0xff000000) >>
						   16) |
	...
	u[2] = m[2] ^ (s[0] << 16) ^ (s[0] >> 16) ^ (s[0] & 0xffff) ^
	    (s[1] & 0xffff) ^ (s[1] >> 16) ^ (s[2] << 16) ^ s[6] ^ (s[6] <<
								    16) ^
	    (s[7] & 0xffff0000) ^ (s[7] >> 16);
	u[3] =
	    m[3] ^ (s[0] & 0xffff) ^ (s[0] << 16) ^ (s[1] & 0xffff) ^ (s[1]
								       <<
								       16)
	    ^ (s[1] >> 16) ^ (s[2] << 16) ^ (s[2] >> 16) ^ (s[3] << 16) ^
	    s[6] ^ (s[6] << 16) ^ (s[6] >> 16) ^ (s[7] & 0xffff) ^ (s[7] <<
								    16) ^
	    (s[7] >> 16);
	u[4] =
	    m[4] ^ (s[0] & 0xffff0000) ^ (s[0] << 16) ^ (s[0] >> 16) ^
	    (s[1] & 0xffff0000) ^ (s[1] >> 16) ^ (s[2] << 16) ^ (s[2] >>
								 16) ^
	...
	u[5] =
	    ...
	    (s[6] >> 16) ^ (s[7] & 0xffff0000) ^ (s[7] << 16) ^ (s[7] >>
								 16);
	u[6] =
	    m[6] ^ s[0] ^ (s[1] >> 16) ^ (s[2] << 16) ^ s[3] ^ (s[3] >> 16)
	    ^ (s[4] << 16) ^ (s[4] >> 16) ^ (s[5] << 16) ^ (s[5] >> 16) ^
	    s[6] ^ (s[6] << 16) ^ (s[6] >> 16) ^ (s[7] << 16);
	u[7] =
	    m[7] ^ (s[0] & 0xffff0000) ^ (s[0] << 16) ^ (s[1] & 0xffff) ^
	    (s[1] << 16) ^ (s[2] >> 16) ^ (s[3] << 16) ^ s[4] ^ (s[4] >>
								 16) ^
	...
	v[7] = h[7] ^ (u[0] & 0xffff0000) ^ (u[0] << 16) ^ (u[7] >> 16) ^
	    (u[1] & 0xffff0000) ^ (u[1] << 16) ^ (u[6] << 16) ^ (u[7] &
								 0xffff0000);
	...
	h[0] =
	    (v[0] & 0xffff0000) ^ (v[0] << 16) ^ (v[0] >> 16) ^ (v[1] >>
								 16) ^
	    (v[1] & 0xffff0000) ^ (v[2] << 16) ^ (v[3] >> 16) ^ (v[4] <<
								 16) ^
	    (v[5] >> 16) ^ v[5] ^ (v[6] >> 16) ^ (v[7] << 16) ^ (v[7] >>
								 16) ^
	    (v[7] & 0xffff);
	h[1] =
	    (v[0] << 16) ^ (v[0] >> 16) ^ (v[0] & 0xffff0000) ^ (v[1] &
								 0xffff) ^
	    v[2] ^ (v[2] >> 16) ^ (v[3] << 16) ^ (v[4] >> 16) ^ (v[5] <<
								 16) ^
	    (v[6] << 16) ^ v[6] ^ (v[7] & 0xffff0000) ^ (v[7] >> 16);
	h[2] =
	    (v[0] & 0xffff) ^ (v[0] << 16) ^ (v[1] << 16) ^ (v[1] >> 16) ^
	    (v[1] & 0xffff0000) ^ (v[2] << 16) ^ (v[3] >> 16) ^ v[3] ^
	    (v[4] << 16) ^ (v[5] >> 16) ^ v[6] ^ (v[6] >> 16) ^ (v[7] &
								 0xffff) ^
	    (v[7] << 16) ^ (v[7] >> 16);
	h[3] =
	    (v[0] << 16) ^ (v[0] >> 16) ^ (v[0] & 0xffff0000) ^ (v[1] &
								 0xffff0000)
	    ^ (v[1] >> 16) ^ (v[2] << 16) ^ (v[2] >> 16) ^ v[2] ^ (v[3] <<
								   16) ^
	    (v[4] >> 16) ^ v[4] ^ (v[5] << 16) ^ (v[6] << 16) ^ (v[7] &
								 0xffff) ^
	    (v[7] >> 16);
	h[4] =
	    (v[0] >> 16) ^ (v[1] << 16) ^ v[1] ^ (v[2] >> 16) ^ v[2] ^
	    (v[3] << 16) ^ (v[3] >> 16) ^ v[3] ^ (v[4] << 16) ^ (v[5] >>
								 16) ^ v[5]
	    ^ (v[6] << 16) ^ (v[6] >> 16) ^ (v[7] << 16);
	h[5] =
	    (v[0] << 16) ^ (v[0] & 0xffff0000) ^ (v[1] << 16) ^ (v[1] >>
								 16) ^
	    (v[1] & 0xffff0000) ^ (v[2] << 16) ^ v[2] ^ (v[3] >> 16) ^ v[3]
	    ^ (v[4] << 16) ^ (v[4] >> 16) ^ v[4] ^ (v[5] << 16) ^ (v[6] <<
								   16) ^
	...
	h[6] =
	    v[0] ^ v[2] ^ (v[2] >> 16) ^ v[3] ^ (v[3] << 16) ^ v[4] ^ (v[4]
								       >>
								       16)
	    ^ (v[5] << 16) ^ (v[5] >> 16) ^ v[5] ^ (v[6] << 16) ^ (v[6] >>
								   16) ^
	    v[6] ^ (v[7] << 16) ^ v[7];
	h[7] =
	    v[0] ^ (v[0] >> 16) ^ (v[1] << 16) ^ (v[1] >> 16) ^ (v[2] <<
								 16) ^
...
void gosthash_final(GostHashCtx * ctx, byte * digest)
{
	...
	if (ctx->partial_bytes > 0) {
		mhash_bzero(&ctx->partial[ctx->partial_bytes],
			    32 - ctx->partial_bytes);
